  ...
  <aside class="sidebar" :class="{ 'sidebar--collapsed': collapsed }">
    ...
    <div class="sidebar__logo">
      ...
      <Transition name="fade">
        <span v-if="!collapsed" class="sidebar__logo-text">
    ...
    <!-- Upgrade Banner -->
    <Transition name="fade">
      <div v-if="!collapsed" class="sidebar__upgrade">
        <div class="sidebar__upgrade-icon"><Zap :size="14" /></div>
        <div class="sidebar__upgrade-content">
          <p class="sidebar__upgrade-title">Upgrade to Pro</p>
          <p class="sidebar__upgrade-desc">Unlimited subtitles</p>
        </div>
      </div>
    </Transition>
    ...
    <nav class="sidebar__nav">
      <div v-for="group in navItems" :key="group.group" class="sidebar__nav-group">
        <Transition name="fade">
          <p v-if="!collapsed" class="sidebar__group-label">{{ group.group }}</p>
        </Transition>
        <router-link
        ...
        >
          ...
          <span v-if="!collapsed && isActive(item.to)" class="sidebar__nav-dot"></span>
        </router-link>
      </div>
    </nav>
    ...
    <!-- Collapse Toggle -->
    <button class="sidebar__toggle" @click="collapsed = !collapsed" :title="collapsed ? 'Expand' : 'Collapse'">
...
.sidebar__nav::-webkit-scrollbar-thumb { background: var(--border-color); border-radius: 4px; }
